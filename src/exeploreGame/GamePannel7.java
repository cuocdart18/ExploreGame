...
public class GamePannel7 extends javax.swing.JPanel {
    ...
    public void level2open(int i, int j) {
        ...
        if (ball == 1 && i == 5 && j == 2 && (boxvalue[8][7] != 0)) {
            boxvalue[8][7] = -1;
        }
        if (ball == 1 && (i != 5 || j != 2) && (boxvalue[8][7] != 0)) {
            boxvalue[8][7] = 24;
        }
        if (ball == 2 && i == 3 && j == 8 && (boxvalue[8][9] != 0 && boxvalue[8][9] != 4)) {
            boxvalue[8][9] = -1;
        }
        if (ball == 2 && (i != 3 || j != 8) && (boxvalue[8][9] != 0 && boxvalue[8][9] != 4)) {
            boxvalue[8][9] = 24;
        ...
        if (boxvalue[i][j] == 23) {
            ...
            if (levelno == 1) {
                ...
                if (score > bestScore) {
                    ...
                    bestScoreLabel.setText("Điểm cao nhất : " + String.format("%02d", bestScore));
                }
                levelLabel.setText("Màn : 2/2");
                JOptionPane.showMessageDialog(controlPannel, "Sang màn tiếp theo");
                levelno = 2;
            ...
            if (levelno == 2) {
                ...
                scoreLabel.setText("Điểm : " + score);
                JOptionPane.showMessageDialog(controlPannel, "Bạn đã thắng");
                gamePannel.home();
            }
        }
        return 0;
    ...
    public void updateBall() {
        ...
        BallLabel.setText("Bóng hiện tại là :- " + str);
    }

    public void showInfo() {
        String str = "1) Sử dụng W để di chuyển bóng lên\n"
                + "2) Sử dụng A để di chuyển bóng sang trái\n"
                + "3) Sử dụng S để di chuyển bóng xuống\n"
                + "4) Sử dụng D để di chuyển bóng sang phải\n"
                + "5) Sử dụng phím SPACE để tập trung đến quả bóng khác\n"
                + "6) Để giành chiến thắng, hãy bất kỳ quả bóng nào chạm tới ô màu Xanh lá cây\n"
                + "7) Đặt quả bóng cụ thể vào ô màu Vàng sẽ mở được ô màu Nâu\n"
                + "8) Nút Chơi lại để thiết lập lại trò chơi\n"
                + "9) Cấp độ đầu tiên mang lại 20 điểm\n"
                + "10) Cấp độ thứ hai mang lại 40 điểm\n"
                + "11) Nếu các phím không hoạt động hoặc bạn mất tập trung khỏi\n"
                + " trò chơi, hãy sử dụng nút Tập trung bóng được hiển thị ở góc dưới bên phải";
        JOptionPane.showMessageDialog(controlPannel, str, "Hướng dẫn", HEIGHT);
        click++;
    }
    ...
    private void initComponents() {
        ...
        add(jButton1);
        jButton1.setBounds(720, 320, 90, 23);

        bestScoreLabel.setFont(new java.awt.Font("TakaoPGothic", 1, 20)); // NOI18N
        ...
        bestScoreLabel.setText("Điểm cao nhất : 00");
        add(bestScoreLabel);
        bestScoreLabel.setBounds(580, 20, 240, 30);

        levelLabel.setFont(new java.awt.Font("Ubuntu", 1, 20)); // NOI18N
        ...
        levelLabel.setText("Màn : 1/2");
        add(levelLabel);
        levelLabel.setBounds(720, 150, 90, 30);

        scoreLabel.setFont(new java.awt.Font("Ubuntu", 1, 20)); // NOI18N
        ...
        BallLabel.setText("Bóng hiện tại là :- ");
        add(BallLabel);
        ...
        add(jLabel1);
        jLabel1.setBounds(160, 20, 420, 32);

        jButton2.setText("Luật");
        ...
        add(jButton2);
        jButton2.setBounds(720, 380, 90, 23);

        jButton3.setText("Tập trung bóng");
        ...
        add(jButton3);
        jButton3.setBounds(690, 450, 120, 23);
