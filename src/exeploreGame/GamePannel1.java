...
public class GamePannel1 extends javax.swing.JPanel {
    ...
    private void movegen(int turn) {
        ...
        if (marked[4] == 0 && ctfill() == 0) {
            index = 4;
        } else if (marked[4] == 0 && ctfill() == 1) {
            index = 4;
        } else if (marked[4] == 1 && ctfill() == 1) {
            random = (int) (Math.random() * 4);
            if (random == 0 && ctfill() == 1) {
                index = 2;
            } else if (random == 1 && ctfill() == 1) {
                index = 6;
            } else if (random == 2 && ctfill() == 1) {
                index = 8;
            } else if (random == 3 && ctfill() == 1) {
                index = 0;
            }
        } else if (marked[0] == bot && marked[1] == bot && marked[2] == 0) {
            index = 2;
        } else if (marked[0] == bot && marked[2] == bot && marked[1] == 0) {
            index = 1;
        } else if (marked[1] == bot && marked[2] == bot && marked[0] == 0) {
            index = 0;
        } else if (marked[3] == bot && marked[4] == bot && marked[5] == 0) {
            index = 5;
        } else if (marked[3] == bot && marked[5] == bot && marked[4] == 0) {
            index = 4;
        } else if (marked[4] == bot && marked[5] == bot && marked[3] == 0) {
            index = 3;
        } else if (marked[6] == bot && marked[7] == bot && marked[8] == 0) {
            index = 8;
        } else if (marked[6] == bot && marked[8] == bot && marked[7] == 0) {
            index = 7;
        } else if (marked[7] == bot && marked[8] == bot && marked[6] == 0) {
            index = 6;
        } else if (marked[0] == bot && marked[3] == bot && marked[6] == 0) {
            index = 6;
        } else if (marked[0] == bot && marked[6] == bot && marked[3] == 0) {
            index = 3;
        } else if (marked[3] == bot && marked[6] == bot && marked[0] == 0) {
            index = 0;
        } else if (marked[1] == bot && marked[4] == bot && marked[7] == 0) {
            index = 7;
        } else if (marked[1] == bot && marked[7] == bot && marked[4] == 0) {
            index = 4;
        } else if (marked[4] == bot && marked[7] == bot && marked[1] == 0) {
            index = 1;
        } else if (marked[2] == bot && marked[5] == bot && marked[8] == 0) {
            index = 8;
        } else if (marked[2] == bot && marked[8] == bot && marked[5] == 0) {
            index = 5;
        } else if (marked[5] == bot && marked[8] == bot && marked[2] == 0) {
            index = 2;
        } else if (marked[0] == bot && marked[4] == bot && marked[8] == 0) {
            index = 8;
        } else if (marked[0] == bot && marked[8] == bot && marked[4] == 0) {
            index = 4;
        } else if (marked[4] == bot && marked[8] == bot && marked[0] == 0) {
            index = 0;
        } else if (marked[2] == bot && marked[4] == bot && marked[6] == 0) {
            index = 6;
        } else if (marked[2] == bot && marked[6] == bot && marked[4] == 0) {
            index = 4;
            ...
            index = 1;
        } else if (marked[1] == me && marked[2] == me && marked[0] == 0) {
            index = 0;
        } else if (marked[3] == me && marked[4] == me && marked[5] == 0) {
            index = 5;
        } else if (marked[3] == me && marked[5] == me && marked[4] == 0) {
            index = 4;
        } else if (marked[4] == me && marked[5] == me && marked[3] == 0) {
            index = 3;
        } else if (marked[6] == me && marked[7] == me && marked[8] == 0) {
            index = 8;
        } else if (marked[6] == me && marked[8] == me && marked[7] == 0) {
            index = 7;
        } else if (marked[7] == me && marked[8] == me && marked[6] == 0) {
            index = 6;
        } else if (marked[0] == me && marked[3] == me && marked[6] == 0) {
            index = 6;
        } else if (marked[0] == me && marked[6] == me && marked[3] == 0) {
            index = 3;
        } else if (marked[3] == me && marked[6] == me && marked[0] == 0) {
            index = 0;
        } else if (marked[1] == me && marked[4] == me && marked[7] == 0) {
            index = 7;
        } else if (marked[1] == me && marked[7] == me && marked[4] == 0) {
            index = 4;
        } else if (marked[4] == me && marked[7] == me && marked[1] == 0) {
            index = 1;
        } else if (marked[2] == me && marked[5] == me && marked[8] == 0) {
            index = 8;
        } else if (marked[2] == me && marked[8] == me && marked[5] == 0) {
            index = 5;
        } else if (marked[5] == me && marked[8] == me && marked[2] == 0) {
            index = 2;
        } else if (marked[0] == me && marked[4] == me && marked[8] == 0) {
            index = 8;
        } else if (marked[0] == me && marked[8] == me && marked[4] == 0) {
            index = 4;
        } else if (marked[4] == me && marked[8] == me && marked[0] == 0) {
            index = 0;
        } else if (marked[2] == me && marked[4] == me && marked[6] == 0) {
            index = 6;
        } else if (marked[2] == me && marked[6] == me && marked[4] == 0) {
            index = 4;
        } else if (marked[4] == me && marked[6] == me && marked[2] == 0) {
            index = 2;
        } else {
            randomfirst();
            this.turn = -turn;
