    ...
    public boolean gameFinish() {
        ...
        if (levelwin == 1) {
            if (level < maxlevel) {
                ...
                JOptionPane.showMessageDialog(controlPannel, "Điểm của bạn : " + bestScore + " ", "Hoàn thành phần chơi", JOptionPane.INFORMATION_MESSAGE);
            }
        }
        return true;
...
//        puzzleGenerate();
    ...
    private void initComponents() {
        ...
        add(newButton);
        newButton.setBounds(650, 430, 110, 23);
        ...
        add(helpButton);
        helpButton.setBounds(650, 550, 110, 23);

        newPicButton.setText("Đổi ảnh");
        ...
        add(newPicButton);
        newPicButton.setBounds(650, 490, 110, 23);
        ...
        movesLabel.setText("Số lượt : 300");
        add(movesLabel);
