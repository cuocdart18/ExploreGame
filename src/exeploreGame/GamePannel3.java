...
public class GamePannel3 extends javax.swing.JPanel implements ActionListener {
    ...
    public void wincheck() {
        ...
        if (queencount == 8) {
            ...
            JOptionPane.showMessageDialog(jPanel2, "Bạn thắng");
            gamePannel.home();
        }
    ...
    private void initComponents() {
        ...
        add(resetButton);
        resetButton.setBounds(690, 410, 100, 23);
        ...
        add(helpButton);
        helpButton.setBounds(690, 470, 100, 23);
    ...
    private void helpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_helpButtonActionPerformed
        JOptionPane.showMessageDialog(jPanel2, "* Đặt 8 quân hậu trên bàn cờ\n"
                + "* Không có quân hậu nào nằm trong đường đi của quân hậu khác\n"
                + "* Hoàn thành game sẽ được 40 điểm\n",
                 "Hướng dẫn",
