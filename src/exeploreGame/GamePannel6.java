...
public class GamePannel6 extends javax.swing.JPanel {
    ...
    public boolean gameFinish() {
        ...
        if (levelwin == 1) {
            if (level < maxlevel) {
                JOptionPane.showMessageDialog(controlPannel, "Sang màn tiếp theo", "Hoàn thành", JOptionPane.INFORMATION_MESSAGE);
                switch (level) {
                    case 1:
                        initBoard2();
                        break;
                ...
                win = 1;
                JOptionPane.showMessageDialog(controlPannel, "Điểm của bạn : " + score + " ", "Hoàn thành phần chơi", JOptionPane.INFORMATION_MESSAGE);
                initBoard1();
                gamePannel.home();
            }
        }
    ...
    public void initBoard1() {
        ...
        level = 1;
        score = 0;
        scoreLabel.setText("Điểm : " + Integer.toString(score));
    ...
    public class moveFood implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            while (localFlag) {
                ...
                int localX = foodPtr.x;
                int localY = foodPtr.y;
    ...
    public void scoreUpdate() {
        ...
        if (score > bestScore) {
            ...
            bestScoreLabel.setText("Điểm cao nhất : " + String.format("%03d", bestScore));
        }
        scoreLabel.setText("Điểm : " + Integer.toString(score));
    }//updates moves
    ...
    private void initComponents() {
        ...
        heading.setText("Rắn săn mồi");
        add(heading);
        heading.setBounds(120, -10, 350, 90);
        ...
        restartButton.setText("Chơi lại");
        ...
        add(restartButton);
        restartButton.setBounds(670, 440, 110, 23);
        ...
        add(helpButton);
        helpButton.setBounds(670, 510, 110, 23);

        resumeButton.setFont(new java.awt.Font("Ubuntu", 0, 15)); // NOI18N
        resumeButton.setText("Chơi");
        ...
        add(resumeButton);
        resumeButton.setBounds(670, 370, 110, 27);
    ...
    private void helpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_helpButtonActionPerformed
        ...
        JOptionPane.showMessageDialog(controlPannel, "* Sử dụng các phím W A S D để di chuyển con rắn\n"
                + "* Nhấn phím SpaceBar để tiếp tục nếu đang tạm dừng\n"
                + "* Bạn có thể chơi nhiều lần tùy thích\n"
                + "* Điểm số tốt nhất của bạn sẽ được cộng vào trò chơi cuối cùng\n"
                + "* Bạn có thể chuyển sang màn khác sau khi hoàn thành một cấp độ\n",
                 "Hướng dẫn",
